...
class OnlineTestBegin extends JFrame implements ActionListener
{
    ...
    OnlineTestBegin(String s)
    {
        ...
        b2=new JButton("SAVE & MARK FOR REVIEW ");
        b1.addActionListener(this);
    ...
    void set()
    {
        ...
        if(current==1)
        {
            l.setText("Que2: . What is the extension of java code files?");
            jb[0].setText(".js");jb[1].setText(".java");jb[2].setText(".class");jb[3].setText(".jdk");
        }
        if(current==2)
        {
        ...
        if(current==3)
        {
            l.setText("Que4: Which of these are selection statements in Java?");
            jb[0].setText("if()");jb[1].setText("break");jb[2].setText("continue");jb[3].setText("for()");
        }
        if(current==4)
        {
        ...
        if(current==9)
        {
            l.setText("Que10: what will be the error in following java code? " +
                    "byte b = 50;\n" +
                    "    b = b * 50;");
            jb[0].setText(" b cannot contain value 50");jb[1].setText("b cannot contain value 100, limited by its range");jb[2].setText("  operator has converted b * 50 into int, which can not be converted to byte without casting");
